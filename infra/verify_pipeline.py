...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4583")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "eef-readings")

SENSOR_TYPES = ["motor_temp_c", "door_cycle_count", "cab_vibration_mm", "load_weight_kg", "travel_speed_mps"]
